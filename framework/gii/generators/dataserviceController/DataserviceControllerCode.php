...
class DataserviceControllerCode extends CCodeModel {
	
	public $model;
	public $controller;
	public $baseControllerClass = 'DController';
	...
	public function prepare() {
		...
		$modulePath				= str_replace( 'controllers', 'modules/dataservices/controllers', $this->controllerFile );
		
		$controllerTemplateFile	=$templatePath.DIRECTORY_SEPARATOR.'dataserviceController.php';
		...
		foreach($files as $file) {
			if( is_file( $templatePath . '/' . $file ) && CFileHelper::getExtension($file) === 'php' && $file !== 'dataserviceController.php' ) {
				$this->files[]=new CCodeFile(
					$this->getModulePath(),
	...
	public function getModulePath() {
		return Yii::app()->modulePath.DIRECTORY_SEPARATOR. 'dataservices/DataservicesModule.php';
	}
}
