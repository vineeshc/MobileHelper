...
class ServiceControllerCode extends CCodeModel {
	...
	public function prepare() {
		...
		$modulePath				= str_replace( 'controllers', 'modules/services/controllers', $this->controllerFile );
		
		$controllerTemplateFile	=$templatePath.DIRECTORY_SEPARATOR.'serviceController.php';
		...
		foreach($files as $file) {
			if( is_file( $templatePath . '/' . $file ) && CFileHelper::getExtension($file) === 'php' && $file !== 'serviceController.php' ) {
				$this->files[]=new CCodeFile(
					$this->getModulePath(),
	...
	public function getModulePath() {
		return Yii::app()->modulePath.DIRECTORY_SEPARATOR. 'services/ServicesModule.php';
	}
}
