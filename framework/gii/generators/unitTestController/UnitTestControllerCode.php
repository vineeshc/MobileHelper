...
class UnitTestControllerCode extends CCodeModel {
	...
	public function rules() {
		return array_merge(parent::rules(), array(
			...
			array( 'operate_id, controller, operate_id', 'required' ),
		));
	}
	...
	public function prepare() {
		...
		//$modulePath				= str_replace( 'controllers', 'tests/unit', $this->controllerFile );
		$modulePath				= 'protected/tests/unit/'.strtolower($this->model)."TestController.php";		
		$controllerTemplateFile	=$templatePath.DIRECTORY_SEPARATOR.'unitTestController.php';
		...
		foreach($files as $file) {
			if( is_file( $templatePath . '/' . $file ) && CFileHelper::getExtension($file) === 'php' && $file !== 'unitTestController.php' ) {
				$this->files[]=new CCodeFile(
					$this->getModulePath(),
	...
	public function getModulePath() {
		//return Yii::app()->modulePath.DIRECTORY_SEPARATOR. 'unitTests/ServicesModule.php';
	}
}
