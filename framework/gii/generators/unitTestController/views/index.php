...
");
?>
<h1>Unit Test Controller Generator</h1>
...
<?php $form=$this->beginWidget( 'CCodeForm', array( 'model'=>$model )); ?>
	...
	<?php /*?><div class="row sticky">
		<?php echo $form->labelEx( $model, 'baseControllerClass' ); ?>
		<?php echo $form->textField( $model, 'baseControllerClass', array( 'size'=>65, 'value'=>'ServiceController' )); ?>
		<div class="tooltip">
	...
	<!--  Code to input the id from the user for unit test case of Update and Delete. starts -->
	<div class="row">
		<?php echo $form->labelEx( $model,'operate_id' ); ?>
		<?php echo $form->textField( $model, 'operate_id', array( 'size'=>65 )); ?>		
		<?php echo $form->error( $model, 'operate_id' ); ?>
	</div>
	<!--  Code to input the id from the user for unit test case of Update and Delete. ends -->
